...
def _find_stat_paths(
    ...
    module files, Data Cleaning, EDA and ML Models under non-system paths. Extra files and
    Data Cleaning, EDA and ML Models under extra directories can also be scanned.
    ...
    for path in chain(list(sys.path), extra_files):
        ...
        for root, dirs, files in os.walk(path):
            ...
            # its parent contained Data Cleaning, EDA and ML Models.
...
class WatchdogReloaderLoop(ReloaderLoop):
    def __init__(self, *args: t.Any, **kwargs: t.Any) -> None:
        ...
        # Extra patterns can be non-Data Cleaning, EDA and ML Models, match them in addition
        # to all Data Cleaning, EDA and ML Models in default and extra directories. Ignore
